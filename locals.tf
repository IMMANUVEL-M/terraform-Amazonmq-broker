...
locals {
  ...
  mq_broker_host_instance_type         = "mq.m5.large" #Choosed the closest matching Size
  ...
  mq_broker_subnet_ids                 = [data.aws_subnet.webapp_subnet_a.id] #this value will be depends_onon deployment mode
